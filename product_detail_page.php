      ...
      <div class="col-sm-12">
        <div class="row">
          ...
          <div class="col-md-6 prodetail caption product-thumb">
            ...
            <hr>
            <label style="margin-top: 4%;">Description:</label>
            <p class="product-desc mtb_30" style="font-size: 16px;"> More room to move. With 80GB or 160GB of storage and up to 40 hours of battery life, the new iPod classic lets you enjoy up to 40,000 songs or up to 200 hours of video or any combination wherever you go. Cover Flow. Browse through your music collection by flipping..</p>
            ...
            <ul class="list-unstyled product_info mtb_20">
              ...
              <li>
                ...
                <span style="font-size: 16px;"> product 20</span>
              </li>
              <li>
                <label>Dimension:</label>
                <span style="font-size: 16px;">20x30x12</span>
              </li>
              <li>
                <label>Weight:</label>
                <span style="font-size: 16px;">250grm</span>
              </li>
              <li>
